		...
		<div name="home" className="bg-[#363534] text-gray-200 w-full h-screen">
			...
			<div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
				...
				<p className="text-[#8892b0] py-4 max-w-[700px]">
					I am a front-end developer who loves to create and build
					intuitive experiences. Currently I am focused on building
					responsive web applications and mobile apps.
				</p>
				<div>
